                ...
                <div class="flex-1 w-full md:w-1/2 xl:w-1/3 p-3">
                    <div class="flex space-x-12">
                        <div class="flex my-auto">
                            ...
                            <h1 class=" my-auto text-sm text-gray-600 font-semibold">(Success)</h1>
                        </div>
                        <div class="flex">
                            <!-- <a class="-mr-3" href="#"><button class="text-sm text-right font-semibold text-indigo-500 border border-indigo-500 h-10 px-5 m-2 rounded bg-gray-100 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-opacity-50">
                                Success
                            </button></a> -->
                                ...
                                foreach($success as $roww){
                                    if ($successCount > 0){
                                        if($roww['paymentStatus'] == 2){
                                            ...
                                            . "</td>
                                            <td width='100px' class='cursor-default text-xs text-center font-bold text-green-700 border-r border-gray-200'><h1 class='p-1 mx-2 bg-green-200 rounded rounded-lg '>PENDING</h1></p>
                                            </tr>";
                                            $i++;
                                        }
                                        else{
