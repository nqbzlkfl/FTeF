	...
	<nav class="flex items-center justify-between flex-wrap bg-blue-900 p-6 fixed w-full z-50 top-0 pt-2 md:pt-1 pb-3 px-1 mt-0 h-auto">
		...
		<div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block pt-6 lg:pt-0" id="nav-content">
			<ul class="list-reset lg:flex justify-end flex-1 items-center">
				...
				<li class="mr-3">
					<a class="inline-block text-white no-underline hover:text-gray-200 hover:text-underline py-2 px-4" href="report.php"><span class="fa fa-exclamation-circle"></span> Report</a>
				</li>
				<li class="mr-3">
