...
<head>
    ...
    <title>FTeF | Change your password</title>
                            ...
                            <tr class="h-10">
                                <td colspan="5">
                                    <div class="mt-4 text-center cursor-pointer justify-start">
                                        <button class="font-semibold text-white h-10 px-5 m-2 rounded bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-opacity-50">
                                            Update
                                        </button>
                                    </div>
                                </td>
