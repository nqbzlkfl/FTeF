...
<head>
    ...
    <title>FTeF | Create Your Account (Tutor)</title>
...
<body class="body-bg min-h-screen pt-8 md:pt-9 pb-6 px-2 md:px-0" style="font-family:'Lato',sans-serif;">
    ...
    <main class="bg-white max-w-lg mx-auto p-8 md:p-8 my-5 rounded-lg shadow-lg">
        <section>
            <h3 class="font-bold text-2xl text-center"><span class="text-blue-600">FK Tutor eFinder</span></br>Registration</h3>
            <p class="text-gray-600 pt-2 text-center">Want to be a tutor? Create your account now.</p>
        </section>

        <section class="mt-6">
            <form class="flex flex-col h-auto relative" method="POST" action="#" enctype="multipart/form-data">
                <?php
