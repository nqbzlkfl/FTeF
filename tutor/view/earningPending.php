                ...
                <div class="flex-1 w-full md:w-1/2 xl:w-1/3 p-3">
                    <div class="flex space-x-12">
                        <div class="flex my-auto">
                            <h1 class="flex-auto text-md justify-start m-2 font-semibold">Billing Management</h1>
                            <h1 class=" my-auto text-sm text-gray-600 font-semibold">(Pending)</h1>
                        </div>
                        <div class="flex">
                            <a class="-mr-3" href="earning.php"><button class="text-sm text-right font-semibold text-indigo-500 border border-indigo-500 h-10 px-5 m-2 rounded bg-gray-100 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-opacity-50">
                                Success(<?=$successCount?>)
                            </button></a>
                            <!-- <a class="-mr-3" href="earningPending.php"><button class="text-sm text-right font-semibold text-indigo-500 border border-indigo-500 h-10 px-5 m-2 rounded bg-gray-100 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-opacity-50">
                                Pending
                            </button></a> -->
                                ...
                                foreach($pending as $roww){
                                    if ($pendingCount > 0){
                                        if($roww['paymentStatus'] == 1){
                                            ...
                                            . "</td>
                                            <td width='100px' class='cursor-default text-xs text-center font-bold text-yellow-600 border-r border-gray-200'><h1 class='p-1 mx-2 bg-yellow-200 rounded rounded-lg '>RECEIVE</h1></p>
                                            </tr>";
                                            $i++;
                                        }
                                        else{
