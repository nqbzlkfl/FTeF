...
<head>
    ...
    <title>FTeF | Feedback for <?=$course?></title>
                        ...
                        <table class="mb-4 table-fixed w-8/12 mx-auto">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    class="mt-4 -mb-1 w-full h-48 flex-1 pt-2 bg-gray-200 rounded text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-blue-600 transition duration-500 px-3 pb-3"
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="rate" id="rate" class="-mb-1 w-full  flex-1 pt-2 bg-gray-200 rounded text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-blue-600 transition duration-500 px-3 pb-3">
                                        <option required value="5">5 Stars</option>
