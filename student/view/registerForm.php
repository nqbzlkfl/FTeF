...
<div class="h-auto">
 ...
 <div x-data="app()" x-cloak>
         ...
         <div x-show.transition="step != 'complete'">	
             ...
             <div class="border-b-2 py-4">
                 <div class="flex-inline flex">
                    <div class="flex-1 uppercase tracking-wide text-xs font-bold text-gray-500 mb-1 leading-tight" x-text="`Step: ${step} of 3`"></div>
                 ...
                 <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                     <div class="flex-1">
                         <div x-show="step === 1">
                             <div class="pt-2 text-lg font-bold text-gray-700 leading-tight">Setup Your Account</div>
                         </div>
                         <div x-show="step === 2">
     ...
     <!-- Bottom Navigation -->	
     <div class="mx-auto bottom-0 left-0 right-0 py-5 bg-transparent" x-show="step != 'complete'">
