...
<head>
    ...
    <title>FTeF | New Course Approval</title>
    ...
    <div class="flex flex-col md:flex-row pt-2">
        ...
        <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
            ...
            <div class="bg-blue-700 p-2 shadow text-xl text-white">
                <h3 class="font-bold pl-2">Course approval by tutor to teach </h3>
            </div>        
                         ...
                         <table class="w-full text-md bg-white shadow-md rounded mb-4 border border-2 table-fixed">
                             <thead>
                                <tr class="border-b text-sm">
                                    ...
                                    <th class="text-left py-3 px-5 border-r border-gray-200">Account Details</th>
                                    <th class="text-left py-3 px-3 border-r border-gray-200">Course Requested</th>
                                    <th class="text-left py-3 px-6 border-r border-gray-200" width="90px">Status</th>
                                    <th class="text-left py-3 px-6 border-r border-gray-200 w-3/12">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                $i=1;
                                foreach($courseV as $roww){
                                    if ($courseN > 0){
                                        if($roww['status'] == 2){
                                            $status = "PENDING";
                                        }
                                        ...
                                        . "<td class='cursor-default text-center my-auto justify-center'><form action='' method='POST'>"
                                            . "<input type='hidden' name='tutorUsername' value='".$roww['courseFull']."'>"
