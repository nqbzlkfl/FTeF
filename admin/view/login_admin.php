...
<body class="body-bg min-h-screen pt-8 md:pt-9 pb-6 px-2 md:px-0" style="font-family:'Lato',sans-serif;">
    ...
    <main class="bg-white max-w-sm mx-auto p-8 md:p-8 my-5 rounded-lg shadow-lg">
        <section>
            <h3 class="font-bold text-2xl text-center"><span class="text-blue-700">FK Tutor eFinder</span> Admin Login</h3>
            <p class="text-gray-600 pt-2 text-center">Only admin can access here.</p>
        </section>

        <section class="mt-6">
            <form class="flex flex-col" method="POST" action="">
                <div class="mb-6 pt-3 rounded bg-gray-200">
                    <label class="block text-gray-700 text-sm font-bold mb-1 ml-3" for="email">Username</label>
