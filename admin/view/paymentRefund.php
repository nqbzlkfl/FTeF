                                ...
                                foreach($refund as $roww){
                                    if ($refundCount > 0){
                                        ...
                                        echo "<tr class='border-b hover:bg-blue-100 bg-gray-100'>"
                                            ...
                                            . "</td>"
                                            . "<td width='100px' class='cursor-default text-sm text-center font-bold text-gray-700 border-r border-gray-200'>REFUND</p>
                                            <td width='100px' class='cursor-default text-sm text-center font-bold text-gray-700 border-r border-gray-200'>FAILED</p>
                                            </tr>";
                                        $i++;
