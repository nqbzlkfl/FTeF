...
<body class="bg-blue-900 font-sans leading-normal tracking-normal mt-12">
    ...
    <nav class="flex items-center justify-between flex-wrap bg-blue-900 p-6 fixed w-full z-20 top-0 pt-2 md:pt-1 pb-3 px-1 mt-0 h-auto">
		<div class="flex items-center flex-shrink-0 text-white mr-6">
			<a class="justify-right pl-4 pt-2 w-5/12" href="dashboard.php">
				<img class="w-full" src="img/logo-vertical-white.png" alt="logo" id="logo-startup">
			</a>
		</div>
		...
		<div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block pt-6 lg:pt-0" id="nav-content">
			<ul class="list-reset lg:flex justify-end flex-1 items-center">
				...
				<li class="mr-3">
					<a class="inline-block text-white no-underline hover:text-gray-200 hover:text-underline py-2 px-4" href="#"><span class="fa fa-sign-out-alt"></span> Log Out</a>
				</li>
    ...
    <div class="flex flex-col md:flex-row pt-2">
        ...
        <div class="bg-blue-900 shadow-lg h-16 fixed bottom-0 mt-auto md:relative md:h-screen z-10 w-full md:w-48">

            <div class="md:mt-12 md:w-48 md:fixed md:left-0 md:top-0 content-center md:content-start text-left justify-between">
                <ul class="list-reset flex flex-row md:flex-col py-0 md:py-3 px-1 md:px-2 text-center md:text-left">
                    <li class="mr-3 flex-1">
                        <a href="dashboard.php" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-purple-500">
                    ...
                    <li class="mr-3 flex-1">
                        <a href="manage_course.php" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-purple-500">
                            <i class="fa fa-book pr-0 md:pr-3"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-gray-600 md:text-gray-400 block md:inline-block">Manage Course</span>
                        </a>
                    </li>
                    <li class="mr-3 flex-1">
                        <a href="manage_schedule.php" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-purple-500">
                            <i class="fas fa-calendar-alt pr-0 md:pr-3"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-gray-600 md:text-gray-400 block md:inline-block">Manage Schedule</span>
                        </a>
                    </li>
                    <li class="mr-3 flex-1">
                        <a href="manage_student.php" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-purple-500">
                            <i class="fa fa-user-graduate pr-0 md:pr-3"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-gray-600 md:text-gray-400 block md:inline-block">Student</span>
                        </a>
                    </li>
                    <li class="mr-3 flex-1">
                        <a href="earning.php" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-purple-500">
                            <i class="fa fa-wallet pr-0 md:pr-3"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-gray-600 md:text-gray-400 block md:inline-block">Earning</span>
                        </a>
                    </li>
                    <li class="mr-3 flex-1">
                        <a href="view_feedback.php" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-purple-500">
                            <i class="fa fa-comment-alt pr-0 md:pr-3"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-gray-600 md:text-gray-400 block md:inline-block">Feedback</span>
                        </a>
                    </li>
                </ul>
            </div>
